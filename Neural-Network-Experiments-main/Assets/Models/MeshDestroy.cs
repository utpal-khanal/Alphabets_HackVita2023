...
public class MeshDestroy : MonoBehaviour
{
    ...
    public bool destroyItOnce = false;/////////////////////////////////////////////////////////
   
    public bool onceDestroyed = false;////////////////////////////////////////////////////////////
    ...
    void Update()
    {
        if (destroyItOnce && !onceDestroyed)
        {
            onceDestroyed = true;
            DestroyMesh();
        }
    ...
    private void DestroyMesh()
    {
        ...
        GameObject g = Instantiate(PlaceHolder, Vector3.zero, Quaternion.identity); ///////////////////////////////////////////////////

        for (var i = 0; i < parts.Count; i++)
        {
            parts[i].MakeGameobject(this);
            parts[i].GameObject.GetComponent<Rigidbody>().AddForceAtPosition(parts[i].Bounds.center * ExplodeForce, transform.position);
            parts[i].GameObject.GetComponent<MeshDestroy>().onceDestroyed = true; /////////////////////////////////////////////////////////////////////
            parts[i].GameObject.transform.parent = g.transform; /////////////////////////////////////////////////////
            int layerNumber = LayerMask.NameToLayer("y");
            parts[i].GameObject.layer = layerNumber;
        }
