...
public class ImageLoader : MonoBehaviour
{
	...
	void Start()
	{
        images = LoadImages(); // byte file to image
		...
		Image[] LoadImages(byte[] imageData, byte[] labelData)
		{
           ...
           // List<double> allPixelValues = new List<double>();
            ...
            System.Threading.Tasks.Parallel.For(0, numImages, (imageIndex) =>
			{
				...
				//Debug.Log(allPixelValues.Length + " px " + pixelValues.Length);
